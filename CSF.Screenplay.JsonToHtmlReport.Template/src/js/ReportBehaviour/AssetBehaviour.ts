...
import { PerformableAsset } from "../Models";
...
export class AssetBehaviour {
    ...
    #base64ToBytes(base64Data : string) {
    ...
    constructor(readonly litebox : DisplaysImage, element : HTMLLIElement, readonly assetModel : PerformableAsset) {
        this.#linkElement = querySelectorNotNull('a', element)
    }
}