...
export class ReportWriter {
    ...
    #createScenarioElement(scenario) {
        ...
        const scenarioIdentifierElement = scenarioElement.querySelector('.scenarioIdentifier');
        if (!scenario.scenario.WasIdentifierAutoGenerated)
            scenarioIdentifierElement.textContent = scenario.scenario.Identifier;
        else
            scenarioIdentifierElement.remove();
