...
namespace CSF.Screenplay.Web.Questions
{
  ...
  public class GetValue : TargettedQuestion<string>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetValue"/> class from a target.
    /// </summary>
    /// <param name="target">Target.</param>
    public GetValue(ITarget target) : base(target) {}

    /// <summary>
    /// Initializes a new instance of the <see cref="GetValue"/> class from a Selenium element.
    /// </summary>
