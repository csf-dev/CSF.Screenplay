...
namespace CSF.Screenplay.WebApis
{
    ...
    /// For an example implementation which serializes the parameters as a JSON string, see <see cref="JsonEndpoint{TParameters}"/>.
    /// </para>
    /// <para>
    ...
    public abstract class ParameterizedEndpoint<TParameters> : EndpointBase
    {
        ...
        /// <remarks>
        /// <para>
        /// When overriding/implementing this method use <see cref="EndpointBase.GetBaseHttpRequestMessageBuilder()"/> to get a builder from the base class.
