...
namespace CSF.Screenplay.Reporting.Models
{
  ...
  public class Scenario
  {
    ...
    readonly bool isScenarioIdAutoGenerated, isFeatureIdAutoGenerated;
    ...
    public virtual bool IsScenarioIdGenerated => isScenarioIdAutoGenerated;
    ...
    /// <summary>
    /// Gets a value which indicates whether the <see cref="FeatureId"/> is auto-generated and thus meaningless.
    /// </summary>
    /// <value><c>true</c> if the feature identifier is generated; otherwise, <c>false</c>.</value>
    public virtual bool IsFeatureIdGenerated => isFeatureIdAutoGenerated;
    ...
    /// <param name="isScenarioIdAutoGenerated">Indicates whether or not the <paramref name="idName"/> is auto-generated</param>
    /// <param name="isFeatureIdAutoGenerated">Indicates whether or not the <paramref name="featureId"/> is auto-generated</param>
    public Scenario(string idName,
                    string friendlyName = null,
                    string featureName = null,
                    string featureId = null,
                    bool isScenarioIdAutoGenerated = false,
                    bool isFeatureIdAutoGenerated = false)
    {
      if(idName == null)
      ...
      this.isFeatureIdAutoGenerated = isFeatureIdAutoGenerated;
      this.isScenarioIdAutoGenerated = isScenarioIdAutoGenerated;

      if(featureId == null)
        this.isFeatureIdAutoGenerated = true;
    }
  }
}
