...
namespace CSF.Screenplay.Selenium.Tests.Waits
{
  ...
  public class WaitUntilVisibleTests
  {
    ...
    public void Wait_UntilVisible_returns_element_with_correct_text(ICast cast, Lazy<BrowseTheWeb> webBrowserFactory)
    {
    ...
    public void Wait_UntilVisible_raises_exception_if_we_dont_wait_long_enough(ICast cast, Lazy<BrowseTheWeb> webBrowserFactory)
    {
      var joe = cast.GetJoe(webBrowserFactory);
