...
namespace CSF.Screenplay.Reporting
{
    ...
    /// <remarks>
    /// <para>
    /// Note that this file was copied directly from <see href="https://github.com/khellang/MimeTypes/blob/v2.5.1/src/MimeTypes/MimeTypes.cs.pp">the
    /// source code for the MimeTypes package</see>.  I had tried to include it via NuGet in the past but the mechanism seems to be incompatible
