...
{
    /// <summary>
    /// Similar to <see cref="IPerformableWithResult{TResult}"/> but provides access to a Selenium WebDriver and a collection of Selenium elements.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This interface is specialised for performables which interact with collections of Selenium elements.
    ...
    public interface IElementCollectionPerformableWithResult<TResult> : ICanReportForElements
    {
        ...
        /// <param name="elements">The single Selenium Element upon which this method should operate.</param>
