...
namespace CSF.Screenplay.Selenium.Actions
{
    ...
    /// <remarks>
    /// <para>
    /// Use this action via the builder method <see cref="PerformableBuilder.DeselectTheOptionWithValue(string)"/>.
    ...
    /// <example>
    /// <para>
    /// This example deselects the option with value "f_fries" from the element with class <c>optional_extras</c>,
