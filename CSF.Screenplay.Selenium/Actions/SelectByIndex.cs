...
{
  /// <summary>
  /// An action driver whereby a user selects an option element by its zero-based index.
  /// </summary>
  public class SelectByIndex : SelectActionDriver
  {
    readonly int index;
    ...
    {
      return $"{actor.Name} selects option {index + 1} from {targetName}.";
    }
    ...
    {
      ability.FlagsDriver.ThrowOnFlag(Flags.HtmlElements.Select.CannotSelectOrDeselectByIndex);

      select.SelectByIndex(index);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="T:CSF.Screenplay.Selenium.Actions.SelectByIndex"/> class.
    /// </summary>
