...
namespace CSF.Screenplay.Selenium.Elements
{
    ...
    public static class TargetExtensions
    {
        ...
        /// </para>
        /// <para>
        /// The method <see cref="Is(ITarget)"/> is functionally identical to this method; the two overloads are
        /// provided just so developers may create a more readable fluent method chain.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The method <see cref="Has(ITarget)"/> is functionally identical to this method; the two overloads are
        /// provided just so developers may create a more readable fluent method chain.
        /// </para>
        /// </remarks>
        /// <param name="target">The target for which to create the query builder.</param>
        /// <returns>A new instance of <see cref="QueryPredicatePrototypeBuilder"/>.</returns>
        public static QueryPredicatePrototypeBuilder Is(this ITarget target) => new QueryPredicatePrototypeBuilder(target, false);
        ...
        /// </para>
        /// <para>
        /// The method <see cref="AreAll(ITarget)"/> is functionally identical to this method; the two overloads are
        /// provided just so developers may create a more readable fluent method chain.
        /// </para>
        /// </remarks>
        /// <param name="target">The target for which to create the query builder.</param>
        ...
        /// </para>
        /// <para>
        /// The method <see cref="AllHave(ITarget)"/> is functionally identical to this method; the two overloads are
        /// provided just so developers may create a more readable fluent method chain.
        /// </para>
        /// </remarks>
        /// <param name="target">The target for which to create the query builder.</param>
        /// <returns>A new instance of <see cref="QueryPredicatePrototypeBuilder"/>.</returns>
        public static QueryPredicatePrototypeBuilder AreAll(this ITarget target) => new QueryPredicatePrototypeBuilder(target, true);
    }
}