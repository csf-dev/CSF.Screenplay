...
public partial class AutofacServiceProvider : IServiceProvider, ISupportRequiredService, IKeyedServiceProvider, IServiceProviderIsService, IServiceProviderIsKeyedService, IDisposable, IAsyncDisposable
{
    ...
    public object? GetKeyedService(Type serviceType, object? serviceKey)
    {
        ...
        {
            // FIXME:  I hacked the try/catch logic out just for now, because I'm only doing a PoC here and it depended upon types which
            // I don't want to include in the PoC.
            // My advice is to depend upon the whole https://github.com/autofac/Autofac.Extensions.DependencyInjection
            // library from NuGet, instead of just copying this one class from there.
